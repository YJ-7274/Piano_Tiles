...
import {SoundAndTextureSwitchingSceneModel} from "./SoundAndTextureSwitchingSceneModel";
import {
    ADragInteraction,
    AGLContext,
    AInteractionEvent,
 ...
 */
export class SoundAndTextureSwitchingSceneController extends App2DSceneController{
    get model():SoundAndTextureSwitchingSceneModel{
        return this._model as SoundAndTextureSwitchingSceneModel;
    }
